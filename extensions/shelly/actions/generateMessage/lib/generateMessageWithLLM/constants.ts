...
export const generatedMessageCategoriesSchema = z.object({
  subject: z.string(), // generated subject
  message: z.string(), // generated message
})

// Create a structured output parser
export const parser = StructuredOutputParser.fromZodSchema(
  generatedMessageCategoriesSchema
)
