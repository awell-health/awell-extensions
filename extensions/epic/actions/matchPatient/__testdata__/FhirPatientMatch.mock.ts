  ...
  entry: [
    {
      link: [
        {
          relation: 'self',
          url: 'https://fhir.epic.com/interconnect-fhir-oauth/api/FHIR/R4/Patient/ePYvjhzgI56-88pdl89yRRQ3',
        },
      ],
      fullUrl:
        'https://fhir.epic.com/interconnect-fhir-oauth/api/FHIR/R4/Patient/ePYvjhzgI56-88pdl89yRRQ3',
      resource: {
