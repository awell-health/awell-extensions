...
export const fields = {
  ...
  patientSignerRole: {
    ...
    description:
      "Must match an existing role in chosen template. It's case-sensitive. Recipient 1 will sign first.",
    type: FieldType.STRING,
    required: true,
  },
  patientSignerName: {
  ...
  providerSignerRole: {
    ...
    description:
      "Must match an existing role in chosen template. It's case-sensitive. Recipient 2 will sign second, after Recipient 1.",
    type: FieldType.STRING,
    required: true,
  },
  providerSignerName: {
  ...
  providerClientUserId: {
    ...
    description:
      'Unique identifier for the second signer used for embedded signing. This should match the stakeholder ID in your care flow.',
    type: FieldType.STRING,
    required: true,
  },
