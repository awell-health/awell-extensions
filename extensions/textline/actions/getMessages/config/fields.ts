...
export const fields = {
  ...
  departmentId: {
    id: 'departmentId',
    label: 'Department Id',
    description: 'The ID of the department from which you want to send the message. Not using a department ID will have the message go out on your first department.',
    type: FieldType.STRING,
    required: false,
  },
