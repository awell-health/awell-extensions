...
export const createCallAndSMSBroadcast: Action<
  typeof fields,
  typeof settings,
  keyof typeof dataPoints
> = {
  key: 'createCallAndSMSBroadcast',
  title: 'Send a new call and|or SMS broadcast',
  description:
    'A broadcast is a feature that allows you to initiate a call and|or SMS to a recipient at specific time',
