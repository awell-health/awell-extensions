...
export type CourseItem = {
  ...
  completion_required_for_next_module?: Maybe<Scalars['Boolean']>;
  ...
  /** Check if course item is unavailable due to CM date restriction */
...
export type GetConversationMembershipsQuery = { __typename?: 'Query', conversationMemberships?: Array<{ __typename?: 'ConversationMembership', convo?: { __typename?: 'Conversation', last_message_content?: string | null, updated_at?: string | null, dietitian_id?: string | null, patient_id?: string | null } | null } | null> | null };
...
export const GetScheduledAppointmentsDocument = gql`
  ...
  appointments(
    ...
    `;
export const GetConversationMembershipsDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getConversationMemberships(variables?: GetConversationMembershipsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: GetConversationMembershipsQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetConversationMembershipsQuery>(GetConversationMembershipsDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getConversationMemberships', 'query');
    }
  };
}
