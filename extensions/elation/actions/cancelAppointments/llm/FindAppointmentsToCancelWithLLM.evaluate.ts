/**
 * LangSmith Evaluation Script for findAppointmentsToCancelWithLLM
 *
 * Evaluates the findAppointmentsToCancelWithLLM function by:
 ...
 *
 * Usage:
 * yarn ts-node extensions/elation/actions/cancelAppointments/llm/FindAppointmentsToCancelWithLLM.evaluate.ts
 *
...
import { findAppointmentsToCancelWithLLM } from './findAppointmentsToCancelWithLLM'
...
const findAppointmentsWithLLMWrapper = async (
  ...
  return await findAppointmentsToCancelWithLLM({
    model,
